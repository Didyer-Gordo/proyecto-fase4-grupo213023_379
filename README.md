# 📘 Proyecto Fase 4 - Grupo 213023379
...
```bash
git clone https://github.com/Grupo-213023379/proyecto-fase4-grupo213023_379.git
```

### 2. Entrar al proyecto

```bash
cd proyecto-fase4-grupo213023_379
```
...
Para dudas o mejoras, contactar al grupo de trabajo del curso.
